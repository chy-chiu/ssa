...
class ReActAgent(AgentBase):
    ...
    def construct_llm_message(self, market_info: MarketInfo):
        ...
        market_info_str = self.get_market_history_str(
            market_info.round_info, open_bidding=bool(market_info.info.get("open_bidding", False))
        )
...
def test_agent():
    ...
    agent = ReActAgent(agent_id="test_agent", tasks=tasks, model=model, verbose=True)
