...
ALL_MODELS = [
    ...
    ("goss", "openai/gpt-oss-120b"),
    ("deepseek", "deepseek/deepseek-chat-v3.1"),
    ("goog", "google/gemini-2.5-flash"),
    ("glm", "z-ai/glm-4.5"),
...
for agent_name, model_name in ALL_MODELS:
    model = OpenAIClient(model_name=model_name, temperature=0.2)
...
exp_log = market.export("logs/llm_baseline_full_p_4.log")
# %%
from ssa.market import LabourMarket, ExperimentLog, Job
